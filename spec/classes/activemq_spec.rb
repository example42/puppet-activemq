...
describe 'activemq' do
  ...
  describe 'Test standard installation with monitoring and firewalling' do
    ...
    it 'should place a firewall rule' do
      content = catalogue.resource('firewall', 'activemq_tcp_42').send(:parameters)[:enable]
      content.should == true
    end
  end
  ...
  describe 'Test customizations - source' do
    ...
    it 'should request a valid source ' do
      content = catalogue.resource('file', 'activemq.conf').send(:parameters)[:source]
      content.should == "puppet://modules/activemq/spec"
    end
